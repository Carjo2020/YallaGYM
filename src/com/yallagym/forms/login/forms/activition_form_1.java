...
public class activition_form_1 extends BaseLogin {
    ...
    public activition_form_1() {
        this(com.codename1.ui.util.Resources.getGlobalResources());

    }

    public activition_form_1(com.codename1.ui.util.Resources res) {
        checkLanguage(res);

    }

    public activition_form_1(com.codename1.ui.util.Resources res, Form frm, String username) {
        ...
        if (!BaseForm.isAndroid()) {
                    gui_btn_back.getAllStyles().setMarginTop(cn1Display.getScaledMax(30));
            gui_lbl_logo.getAllStyles().setMarginTop(cn1Display.getScaledMax(16));
        }
    }
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">                          
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setScrollableY(true);
                setInlineStylesTheme(resourceObjectInstance);
        setTitle("activition_form_1");
        setName("activition_form_1");
        ...
        gui_Container_2.setPreferredSizeStr("77.24868mm 20.37037mm");
        ...
        ((com.codename1.ui.layouts.LayeredLayout)gui_Container_2.getLayout()).setPreferredWidthMM((float)73.01588);
        ((com.codename1.ui.layouts.LayeredLayout)gui_Container_2.getLayout()).setPreferredHeightMM((float)20.37037);
        ...
        ((com.codename1.ui.layouts.LayeredLayout)gui_lbl_logo.getParent().getLayout()).setInsets(gui_lbl_logo, "7.0% auto auto auto").setReferenceComponents(gui_lbl_logo, "-1 -1 -1 -1").setReferencePositions(gui_lbl_logo, "0.0 0.0 0.0 0.0");
